...
const Footer = () => {
    return (
        ...
        <footer className="bg-gray-900 text-gray-300 p-4 md:p-6 mt-6">
            <div className="max-w-[1440px] mx-auto">
                <div className="grid grid-cols-2 gap-8 md:grid-cols-4 pb-10 border-b border-gray-700">

                    <div className="col-span-2 md:col-span-1">
                        <h3 className="text-xl font-bold text-white mb-2">HERO.IO</h3>
                        <p className="text-sm text-gray-500">Simplify your life.</p>
                    </div>
                ...
                <div className="pt-6 flex flex-col md:flex-row justify-center items-center text-sm text-gray-500">
                    <p className="mb-2 md:mb-0 text-center">
                        &copy; 2025 Apps Store Ltd. All rights reserved by TurzO
                    </p>
                </div>
            </div>
        </footer>
